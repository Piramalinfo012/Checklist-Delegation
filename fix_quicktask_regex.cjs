...
const regex = /PAGE_CONFIG: \{\s*title: "Task Management",\s*description: "Showing your tasks"\s*\/\/ Skip header row and search for user/m;
...
if (content.match(regex)) {
  ...
  console.log("Restored and optimized fetchCurrentUser successfully with flexible regex!");
} else {
  console.log("Could not find it even with flexible regex.");
}
